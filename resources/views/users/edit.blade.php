...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{ route('users.save', $user->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-auto">
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <a href="{{ route('users.index') }}" class="btn btn-danger"><i class="fa-solid fa-ban me-1"></i>Cancel</a>
                        </div>
                        <div class="col-auto">
